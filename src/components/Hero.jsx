...
const Hero = () => {
  ...
  // if local storige is empty save theme as light
  useEffect(() => {
    ...
    <section className='min-h-[740px] w-full bg-heroLight bg-cover bg-center bg-no-repeat overflow-hidden dark:bg-heroDark'>
      <div className="container mx-auto px-4 lg:px-0">
        <header className='flex items-center justify-between py-8'>
          ...
          {/* button */}
          <button onClick={handleSwitchTheme} className='p-4 bg-accent text-white rounded-full w-12 h-12 flex justify-center items-center'>
